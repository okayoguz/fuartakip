...
.sidenav a {
    ...
    text-decoration: none;
    font-size: 25px;
    color: #;background-colour:#6959CD;
    display: block;
    transition: 0.3s
}
...
<body background="duvar.jpg">
	...
	<div style="width:80%;margin:auto;"><a href="kontrol.php?islem=cikis" class="badge badge-primary" style="float:right;font-size:110%;background-color:#6959CD">Çıkış Yap</a></div>
...
<div id="flipkart-navbar" style="width:80%;margin:auto;text-align:center;height:40px"> 
            ...
            <ul class="largenav pull-right">
				...
				<li style="font-size:23px" class="upper-links"><a class="links" href="ilgiler.php">İlgiler</a></li>
				<li style="font-size:23px" class="upper-links"><a class="links" href="bilgilerim.php">Bilgilerimi Düzenle</a></li>
            </ul>
...
<div id="mySidenav" class="sidenav">
    <div class="container" style="background-color: #6959CD; padding-top: 10px;">
        <span class="sidenav-heading">FUARAWAY</span>
        <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a>
    </div>
    <a href="fuarindex.php">Anasayfa</a>
    <a href="fuarlar.php">Fuarlar</a>
    <a href="önerilenler.php">Önerilenler</a>
    <a href="gittiklerim.php">Gittiklerim</a>
	<a href="ilgiler.php">İlgiler</a>
	<a href="bilgilerim.php">Bilgilerim</a>
</div>
<br>
